...
#Change the output location to a network share location or your flash drive assigned drive letter. 
$csvObject | Select PCName, OS, Manufacturer, Model, RAM, HDDSize, CPU, SerialNumber  | Export-Csv 'I:\Information Services\IS\HelpDesk_Group\PC_Techs\SystemInfo\system-info.csv' -NoTypeInformation -Append
